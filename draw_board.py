...
white_pawn = cpm.Chessp('wp',  'white', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(0, 0, 0))), white_pawn_image), Hex(0, 0, 0), True)
white_bishop = cpm.Chessp('b', 'white', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(1, 0, -1))), white_bishop_image), Hex(1, 0, -1), True)
white_knight = cpm.Chessp('n', 'white', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(2, -1, -1))), white_knight_image), Hex(2, -1, -1), True)
white_rook = cpm.Chessp('r', 'white', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(-1, 1, 0))), white_rook_image), Hex(-1, 1, 0), True)
white_queen = cpm.Chessp('q', 'white', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(-2, 1, 1))), white_queen_image), Hex(-2, 1, 1), True)
white_king = cpm.Chessp('k', 'white', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(0, 3, -3))), white_king_image), Hex(0, 3, -3), True)
black_pawn = cpm.Chessp('bp', 'black', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(0, -5, 5))), black_pawn_image), Hex(0, -5, 5), True)
black_bishop = cpm.Chessp('b', 'black', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(0, 5, -5))), black_bishop_image), Hex(0, 5, -5), True)
black_knight = cpm.Chessp('n', 'black', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(5, -5, 0))), black_knight_image), Hex(5, -5, 0), True)
black_rook = cpm.Chessp('r', 'black', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(-5, 5, 0))), black_rook_image), Hex(-5, 5, 0), True)
black_queen = cpm.Chessp('q', 'black', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(-5, 0, 5))), black_queen_image), Hex(-5, 0, 5), True)
black_king = cpm.Chessp('k', 'black', something.create_image_token((hex_to_pixel(BOARD_LAYOUT, Hex(5, 0, -5))), black_king_image), Hex(5, 0, -5), True)
